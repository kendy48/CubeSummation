...
public class YoutubeTests {
    ...
    private static Credential authorize(List<String> scopes) throws Exception {
        ...
        // Load client secrets.
        GoogleClientSecrets clientSecrets = new GoogleClientSecrets();// GoogleClientSecrets.load(JSON_FACTORY, UploadVideo.class.getResourceAsStream("/client_secrets.json"));

        GoogleClientSecrets.Details details= new GoogleClientSecrets.Details();
        details.setClientId("1030680502832-cpppnoo7f10m4cn6u5k5gju5q1bril9e.apps.googleusercontent.com");
        details.setClientSecret("GxDYC3TiCTJGojWIuFHIYA1O");
